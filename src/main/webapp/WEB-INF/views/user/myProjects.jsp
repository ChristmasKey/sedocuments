...
<div style="overflow: auto;float: left;width: 22%;height: 100%;" id="treeDiv">
    <ul id="projectTree" class="dtree" data-id="0"></ul>
</div>
<%--左侧树结束--%>
<%--头部工具栏开始--%>
...
<script type="text/javascript">
    layui.extend({
    ...
    }).use(['jquery','element','layer','form','dtree'],function () {
        var $=layui.jquery;
        var layer=layui.layer;
        var form=layui.form;
        var dtree=layui.dtree;
        var projectTree=dtree.render({
            elem:'#projectTree',
        ...
        //监听节点的单击事件
        dtree.on("node(projectTree)",function (obj) {
            if (!obj.param.leaf) {
                var $div=obj.dom;
                projectTree.clickSpread($div);
